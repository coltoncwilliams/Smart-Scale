...
final class ConnectTableViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, BluetoothSerialDelegate {
...
//MARK: Functions
    ...
    override func viewDidLoad() {
        ...
        serial.startScan()
        Timer.scheduledTimer(timeInterval: 10, target: self, selector: #selector(ConnectTableViewController.scanTimeOut), userInfo: nil, repeats: false)
    }
...
//MARK: UITableViewDelegate
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        Timer.scheduledTimer(timeInterval: 10, target: self, selector: #selector(ConnectTableViewController.connectTimeOut), userInfo: nil, repeats: false)
    }
...
//MARK: BluetoothSerialDelegate
    ...
    func serialDidDiscoverPeripheral(_ peripheral: CBPeripheral, RSSI: NSNumber?) {
        ...
        os_log("Found Device", log: OSLog.default, type: .debug)
